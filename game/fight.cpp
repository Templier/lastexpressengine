...
void Fight::handleTick(const Common::Event &ev, bool isProcessing) {
	...
	if (_data->index) {
		...
		_data->index--;
		_data->sequences[_data->index] = Sequence::loadSequence(getArchive(_data->names[_data->index]));
	}
}
...
void Fight::loadMilosPlayer() {
	...
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2001cr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2001cdl.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2001cdr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2001cdm.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2001csgr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2001csgl.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2001dbk.seq")));
}

void Fight::loadMilosOpponent() {
	REGISTER_OPPONENT_FUNCTIONS(Milos)

	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2001or.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2001oal.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2001oam.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2001okl.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2001okm.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2001dbk.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2001wbk.seq")));
...
void Fight::loadAnnaPlayer() {
	...
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2002cr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2002cdl.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2002cdr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2002cdm.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2002lbk.seq")));
}
...
void Fight::loadAnnaOpponent() {
	...
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2002or.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2002oal.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2002oam.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2002oar.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2002okr.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2002okml.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2002okm.seq")));
...
void Fight::loadIvoPlayer() {
	...
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2003cr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2003car.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2003cal.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2003cdr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2003cdm.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2003chr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2003chl.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2003ckr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2003lbk.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2003fbk.seq")));
...
void Fight::loadIvoOpponent() {
	...
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2003or.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2003oal.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2003oar.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2003odm.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2003okl.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2003okj.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("blank.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("csdr.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2003l.seq")));
...
void Fight::loadSalkoPlayer() {
	...
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2004cr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2004cdr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2004chj.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2004bk.seq")));
...
void Fight::loadSalkoOpponent() {
	...
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2004or.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2004oam.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2004oar.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2004okr.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2004ohm.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("blank.seq")));
...
void Fight::loadVesnaPlayer() {
	...
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2005cr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2005cdr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2005cbr.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2005bk.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2005cdm1.seq")));
	_data->player->sequences.push_back(Sequence::loadSequence(getArchive("2005chl.seq")));
}

void Fight::loadVesnaOpponent() {
	REGISTER_OPPONENT_FUNCTIONS(Vesna)

	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2005or.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2005oam.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2005oar.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2005okml.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2005okr.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2005odm1.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2005csbm.seq")));
	_data->opponent->sequences.push_back(Sequence::loadSequence(getArchive("2005oam4.seq")));
